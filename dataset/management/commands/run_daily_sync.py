...
class Command(BaseCommand):
    help = "每天定时执行 sync_dataset，默认在 Asia/Shanghai 时区 11:35 运行"

    def add_arguments(self, parser):
        parser.add_argument("--hour", type=int, default=11, help="每日执行小时，默认 11")
        parser.add_argument("--minute", type=int, default=35, help="每日执行分钟，默认 35")
